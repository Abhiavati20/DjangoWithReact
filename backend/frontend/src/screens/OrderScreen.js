...
function OrderScreen({ match, history }) {
    ...
    const addPayPalScript = () => {
        ...
        script.src = 'https://www.paypal.com/sdk/js?client-id=AdSeYza-00Uor5jFD2rThA8AZhv46l7oVb_Fcog0Yonl100eOjYJL47_grFxNTfrRqFRtshb7WgAqD9f'
        script.async = true
        script.onload = () => {
            setSdkReady(true)
        }
                                            ...
                                            <ListGroup variant='flush'>
                                                {order.orderItems.map((item, index) => (
                                                    <ListGroup.Item key={index}>
                                                        <Row>
                                                            <Col md={1}>
                                                                <Image src={item.src} alt={item.name} fluid rounded />
                                                            </Col>
